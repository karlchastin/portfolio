...
export async function swapData(tabName) {
    ...
    const displayMap = {
        ...
        'steam-activity-wrapper': { show: newLayout.showSteamActivity, type: 'block' },
        ...
        'home-wrapper': { show: newLayout.showHome, type: 'block' },
        'about-wrapper': { show: newLayout.showAbout, type: 'block' },
        'tech-stack-wrapper': { show: newLayout.showTech, type: 'block' },
        'certifications-wrapper': { show: newLayout.showCertifications, type: 'block' },
        'experience-wrapper': { show: newLayout.showExperience, type: 'block' },
        'blog-wrapper': { show: newLayout.showBlog, type: 'block' },
        'contact-wrapper': { show: newLayout.showContact, type: 'block' }
    };
